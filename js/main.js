...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const roomData = {
    ...
    'experience-event': {
      title: 'Event Space',
      description: 'MANTAPA - Featuring a traditional design with terracotta tile roof, this open air structure is a perfect center piece for any event or retreat. \n AMPHITHEATRE- This serene amphitheater amidst our tall green trees is the ideal spot for hosting dreamy wedding events, off-beat corporate gatherings, fun sport meets or arejuvenating yoga retreat!',
      features: [
        '100 chairs included',
